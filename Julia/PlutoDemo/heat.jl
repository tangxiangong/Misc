...
# ╔═╡ c4305d76-7a2c-11ee-237a-db21693c5c58
using Gridap, GridapGmsh, IterativeSolvers

# ╔═╡ 28f28111-e723-4aea-84fd-044b8dd68986
import GridapGmsh:gmsh

# ╔═╡ 7e68e932-a0c9-4670-a109-bd671cb3e72b
begin 
	T = 1
	domain = (0, 1, 0, 1)
	h = 1/128
	...
	f(x, t) = 2 * π^2 * sinpi(x[1]) * sinpi(x[2]) * exp(t)
	nothing
end

# ╔═╡ 23ad5acc-f985-4505-a9bf-93fc3469b352
generateFEMs()

# ╔═╡ 98aa9cd8-5d07-4520-9479-abbd971b4990
...
# ╔═╡ b2f4d5af-a734-4705-975a-934d4485cb4b
...
# ╔═╡ 1a20621b-1ef1-4f3e-81ab-d909a9ff0fec
...
# ╔═╡ 3710a540-87ec-4316-9983-fee91b61132e
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "c517ddf3731c955bd2f5ecb49b5b6a04f845cc36"
...
git-tree-sha1 = "195693c3f9cdefd3e5b9b93a6954127d1bbc220c"
