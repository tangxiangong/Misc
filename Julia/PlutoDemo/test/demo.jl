...
#> [frontmatter]
#> title = "Gridap.jl 使用教程"
#> tags = ["Julia", "FEM"]
#> description = "使用 Gridap.jl 快速实现有限元算法"
#> 
#>     [[frontmatter.author]]
#>     name = "小雨"
#>     url = "https://xiaoxiaoyu.me"

using Markdown
using InteractiveUtils

# ╔═╡ 121085f2-7b1d-11ee-1baa-0b48a42e2047
using Gridap, GridapGmsh

# ╔═╡ 836d6b63-e69e-484e-97fa-43b0653b8964
using PlutoExtras; initialize_eqref()

# ╔═╡ ed6b2f3c-47e2-41a5-bc98-78ffaabe0f25
md"""# [Gridap.jl](https://github.com/gridap/Gridap.jl) 使用教程 """

# ╔═╡ bc5a18b9-6f77-4925-a888-3bcc15a88aba
md"## Poisson 方程示例"

# ╔═╡ be3a52f5-6864-431b-82de-30b0735ba500
md"""
### 模型与有限元格式
Poisson 方程
$(texeq"-\Delta u = f,\; \text{ in } \Omega,\quad u = 0, \; \text{ on } \partial\Omega,\label{Poisson}")
"""

# ╔═╡ e06df6ff-3ddf-41bc-bb97-d57033b7ae26
import GridapGmsh:gmsh

# ╔═╡ de3a46a8-6756-4b42-a1f5-0e7fa708f5f1
# spatial_mesh((0, 1, 0, 1), 0.1)

# ╔═╡ 47c45592-39bb-42c4-b378-7400919bf02e
...
manifest_format = "2.0"
project_hash = "db1dd06b74aa83c495a95dddeaa5f847b095fa64"
