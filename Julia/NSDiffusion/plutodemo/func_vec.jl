...
# ╔═╡ 187da4e4-bc14-45a1-abd0-5237c0035a10
using Gridap

# ╔═╡ 3ba9e2b2-9e45-40f9-b70d-58e6f5afa4a5
model = CartesianDiscreteModel((0,1,0,1),(10,10))

# ╔═╡ 25cd5123-73b4-4494-8c4e-524a9cf77cc8
reffe = ReferenceFE(lagrangian, Cdouble, 1)

# ╔═╡ 5e75bc2d-fde9-4218-969d-f7d9bee66ed2
V = TestFESpace(model, reffe, conformity=:H1, dirichlet_tags="boundary")

# ╔═╡ 4e4a2b4b-ce3e-4e4f-8a51-8cb0173098bf
U = TrialFESpace(V, 0.0)

# ╔═╡ 38b52d16-d4bc-449c-b200-6ac06ae5ee9e
function Vector{FEFunction}(n::Int, U::TrialFESpace)
	m = num_free_dofs(U)
	fef = FEFunction(U, zeros(m))
	[fef for _ in 1:n]
end

# ╔═╡ c00d3c15-bcb3-4428-b9ca-607d202d6f12
v = Vector{FEFunction}(10, U)

# ╔═╡ a42afec7-03b4-4181-9597-922ac11b6771
f(x) = x[1] + x[2]

# ╔═╡ ba815d38-a716-42c7-ae13-dd337d70d766
v[1] = interpolate(f, U)

# ╔═╡ 010f52de-3c93-4890-9144-38c5f102e6c1
v[1]
...
manifest_format = "2.0"
project_hash = "5a002cf3719049c6b6da7660921c05db458ddcc9"
